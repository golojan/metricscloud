...
const AddIndicator: NextPage = () => {
  ...
  const addIndicator = async (e: React.SyntheticEvent) => {
    e.preventDefault();
    dispatch.settings.setBusy(true);
    const response = await fetch('/api/indicators/add', {
      method: 'POST',
      headers: {
      ...
      <div id="appCapsule">
        ...
        <div className="section pt-1">
          <div className="row mt-2">
            ...
            <div className="col-8">
              <form onSubmit={addIndicator} className="stat-box">
